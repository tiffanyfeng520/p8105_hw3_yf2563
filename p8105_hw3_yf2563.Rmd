...
summary(ny_noaa)
```
Description: The dimension of this dataset is `r dim(ny_noaa)`. This dataset contains `r nrow(ny_noaa)` rows and `r ncol(ny_noaa)` columns. The variables include `r ls(ny_noaa)`. 
...
Description: The dimension of the cleaned dataset is `r dim(ny_noaa_clean)`. This dataset contains `r nrow(ny_noaa_clean)` rows and `r ncol(ny_noaa_clean)` columns. The variables include `r ls(ny_noaa_clean)`. 
